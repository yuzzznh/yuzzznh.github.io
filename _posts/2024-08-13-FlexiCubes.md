...
### 4.2 Flexible Dual Vertex Positioning & <span style='color: #f4acb6'>Interpolation Weights</span> $\textcolor{#f4acb6}{\alpha}$<span style='color: #f4acb6'>, </span>$\textcolor{#f4acb6}{\beta}$
...
- <span style='color: #f4acb6'>DMC에 additional flexibility를 도입</span>하기 위해, 저자들은 먼저 <span style='color: #f4acb6'>각 grid cell마다 </span>$\textcolor{#f4acb6}{\alpha \in \mathbb{R}^8_{>0}}$<span style='color: #f4acb6'>라는 weight 집합을 정의한다. </span>$\textcolor{#f4acb6}{\alpha}$<span style='color: #f4acb6'>는 </span><span style='color: #f4acb6'>각 cube corner에 양의 스칼라 값을 하나씩 연결짓는다. </span>따라서 $\alpha$는 각 edge 위에 있는 <span style='color: #f4acb6'>crossing point</span> $\textcolor{#f4acb6}{c_e}$<span style='color: #f4acb6'>의 위치를 조정한다.</span> 그러면 $\textcolor{#f4acb6}{u_e}$<span style='color: #f4acb6'>의 위치</span>를 결정하던 Equation 3은 다음의 Equation 5로 대체된다.
...
- 한편, 위와 마찬가지로, <span style='color: #a6a6a6'>original DMC에서처럼 dual vertex를 그냥 naive하게 primal face의 centroid에 위치시키기보다는,</span> 저자들은 <span style='color: #f4acb6'>각 grid cell마다 </span>$\textcolor{#f4acb6}{\beta \in \mathbb{R}^{12}_{>0}}$<span style='color: #f4acb6'>라는 weight 집합을 정의한다. </span>$\textcolor{#f4acb6}{\beta}$<span style='color: #f4acb6'>는 각 cube edge에 양의 스칼라 값을 하나씩 연결짓는다. (</span>$\textcolor{#f4acb6}{\alpha}$<span style='color: #f4acb6'>는 cube corner에, </span>$\textcolor{#f4acb6}{\beta}$<span style='color: #f4acb6'>는 cube edge에!) </span>따라서 $\textcolor{#f4acb6}{\beta}$<span style='color: #f4acb6'>는 </span><span style='color: #f4acb6'>각 face 안에서 dual vertex의 위치를 조정</span>하는 역할을 한다. 그러면 $\textcolor{#f4acb6}{v_d}$<span style='color: #f4acb6'>의 위치</span>를 결정하던 Equation 4는 다음의 Equation 6으로 대체된다.
...
### 4.3 Flexible Quad Splitting & <span style='color: #f4acb6'>Splitting Weights</span> $\textcolor{#f4acb6}{\gamma}$
...
### 4.4 Flexible Grid Deformation & <span style='color: #f4acb6'>Deformation Vectors</span> $\textcolor{#f4acb6}{\delta}$
